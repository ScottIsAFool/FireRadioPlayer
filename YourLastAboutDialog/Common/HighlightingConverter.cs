                    ...
                    TextBlock tb = new TextBlock
                                       {
                                           ...
                                           Text = line,
                                           Style = highlight ? (Style)Application.Current.Resources["PhoneTextExtraLargeStyle"] : (Style)Application.Current.Resources["PhoneTextNormalStyle"],
                                           Margin = highlight ? new Thickness(0, 3, 0, 0) : new Thickness(0),
                                           Foreground = highlight ? (SolidColorBrush)Application.Current.Resources["PhoneAccentBrush"] : (SolidColorBrush)Application.Current.Resources["PhoneForegroundBrush"]
                                       };
