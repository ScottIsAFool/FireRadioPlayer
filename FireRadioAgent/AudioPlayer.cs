...
namespace FireRadioAgent
{
    public class AudioPlayer : AudioPlayerAgent
    {
        private static volatile bool _classInitialized;
        private static AudioTrack FireTrack = new AudioTrack(new Uri("mms://wm9.spacialnet.com/fireradio1076", UriKind.Absolute),
                           "Fire Radio Player",
                           "Fire Radio",
                           "Fire Radio",
                           new Uri("Shared/Media/FireRadio.jpg", UriKind.Relative),
        ...
        protected override void OnPlayStateChanged(BackgroundAudioPlayer player, AudioTrack track, PlayState playState)
        {
            switch (playState)
            {
                ...
                case PlayState.Stopped:
                    EditTag(track, "Stopped", "Fire Radio");
                    break;
                case PlayState.Paused:
                    break;
                case PlayState.Playing:
                    EditTag(track, "Playing", "Fire Radio");
                    break;
                case PlayState.BufferingStarted:
                    EditTag(track, "Buffering", "Buffering...");
                    break;
        ...
        private void EditTag(AudioTrack track, string message, string extraInfo)
        {
            track.BeginEdit();
            track.Tag = message;
            track.Artist = extraInfo;
            track.EndEdit();
        }
